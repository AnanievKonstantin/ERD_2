...
class DataController
{
    public:
         ...
         * @param mode
         *  0 - invoke from removeEssence Func: must remove system key
         *  1 - invoke from GUI: do not remove system key
         * @return
         *	0 если все хорошо
         *	!0 если что то пошло не так
         */
        int removeRelation(QString id_first, QString id_second, int mode);
         ...
         *	имя ключа
         * @param mode
         *  Тип запроса на удалени
         *  0 = remove with removing essence
         *  1 = remove with removing relation
         *  2 = remove with removing just key
         * @return
         *	0 если все хорошо
         *	!0 если что то пошло не так
         */
        int removeKey(QString id, QString key_name, int mode);
